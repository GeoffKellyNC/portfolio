...
export const projectData = [
  {
    ...
    imageSrc : berryBot,
    technologies : [
      'ReactJS', 'Redux', 'Styled-Components', 'Node.JS', 'Express', 'JWT',
      'TWITCH API', 'TWURPLE', 'React Router V6', 'SQL', 'MySQL', 'bycrypt',
      'Axios', 'Git'
    ],
  ...
  },
  {
    ...
    technologies :
        [ 'ReactJS', 'VSCode', 'Git', 'Cypress', 'JavaScript', 'Redux', 'API' ],
  ...
  },
  {
    ...
    imageSrc : appTracker,
    technologies : [
      'ReactJS', 'VSCode', 'Git', 'Cypress', 'NODE', 'JavaScript', 'Redux',
      'API', 'PostgreSQL'
    ],
